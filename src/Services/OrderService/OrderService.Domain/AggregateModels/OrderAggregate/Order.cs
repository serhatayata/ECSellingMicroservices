...
{
    public class Order : BaseEntity, IAggregateRoot //BaseEntity because with EF, will be created as a table, This is an aggregate root model.
    {
        ...
        private void AddOrderStartedDomainEvent(string userName, int cardTypeId, 
