    ...
    public class CatalogContextSeed
    {
        ...
        private IEnumerable<CatalogItem> GetCatalogItemsFromFile(string contentPath, CatalogContext context)
        {
            IEnumerable<CatalogItem> GetPreconfiguredItems()
            {
                ...
                {
                    new CatalogItem() { CatalogTypeId = 2, CatalogBrandId = 2, AvailableStock = 100, Description = ".NET Bot Black Hoodie and more", Name= ".NET Black Hoodie", Price = 19.5M, PictureFileName = "1.png", OnReorder = false },
                    new CatalogItem() { CatalogTypeId = 1, CatalogBrandId = 2, AvailableStock = 100, Description = ".NET Black & White Mug", Name= ".NET Black & White Mug", Price = 8.5M, PictureFileName = "2.png", OnReorder = false },
